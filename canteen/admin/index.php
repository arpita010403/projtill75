    ...
    <div class="row">
        <div class="col-md-12 bg-dark p-1 d-flex align-items-center">
            ...
            <div class="button text-center">
                ...
                <button class="my-3"><a href="index.php?view_categories" class="nav-link text-warning bg-light p-2">View Category</a></button>
                <button class="my-3"><a href="index.php?list_orders" class="nav-link text-warning bg-light p-2">Orders</a></button>
                <button class="my-3"><a href="index.php?list_payments" class="nav-link text-warning bg-light p-2">Payments</a></button>
                <button class="my-3"><a href="index.php?list_users" class="nav-link text-warning bg-light p-2">Users</a></button>
                <button class="my-3"><a href="" class="nav-link text-warning bg-light p-2">Feedback</a></button>
